"""
ThreatQuest Cyber Hunt India — SQLite database layer.
...
A single file `ThreatQuest Cyber Hunt.db` is created next to this module.
"""
...
DB_FILE = os.path.join(DATA_DIR, "ThreatQuest Cyber Hunt.db")
...
def add_community_event(e):
    ...
    rec = {
        ...
        "platform": clean(e.get("platform"), 30) or ("ThreatQuest Cyber Hunt" if is_hack else "Community"),
